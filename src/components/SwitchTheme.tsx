interface SwichThemeProps {
  themeNum: number
  setThemeNum: (themeNum: number) => void
}

const SwichTheme = ({ themeNum, setThemeNum }: SwichThemeProps) => {
  ...
  return (
    <div className="swich-theme">
      ...
      <div className="swich-theme__control">
        ...
        <div
          className="swich-theme__control__outer"
          style={getSliderPosStyle()}
        >
          <div
